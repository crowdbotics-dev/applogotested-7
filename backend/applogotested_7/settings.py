"""
Django settings for applogotested_7 project.
...
ROOT_URLCONF = 'applogotested_7.urls'
...
WSGI_APPLICATION = 'applogotested_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "applogotested_7 API",
    "DESCRIPTION": "API documentation for applogotested_7 App",
    "VERSION": "v1",
}
